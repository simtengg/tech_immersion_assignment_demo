module assignment_demo_2023

go 1.20

require (
	github.com/TikTokTechImmersion/assignment_demo_2023/http-server v0.0.0-20230612032000-da19aa78ae33 // indirect
	...
	github.com/cloudwego/kitex v0.6.0 // indirect
